			...
			loaders.each(function()
			{
		    	...
		    	.on('start', function()
		    	{
		    		var bar = new ProgressBar.Circle(loader,
					{
						...
						from:{ color: '#5a2360', width: 1 },
						to: { color: '#5a2360', width: 1 },
						...
						step: function(state, circle)
						{
							...
							circle.setText(value + '<span class="progress_perc">%</span>');
						}
					});
					bar.text.style.fontFamily = '"Playfair Display", serif';
					bar.text.style.fontSize = '60px';
					bar.text.style.fontWeight = '700';
					bar.text.style.color = "#333333";
